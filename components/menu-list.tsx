                ...
                <NavigationMenuLink asChild>
                  ...
                  >
                    ...
                    <p className="text-sm leading-tight text-muted-foreground">
                      Sumergete en el apasionante mundo del café con nuestra web.
                    </p>
                  </a>
                </NavigationMenuLink>
              </li>
...
const components: { title: string; href: string; description: string }[] = [
    {
      ...
      href: "/category/grano",
      description:
        "Granos de café enteros que requieren ser molidos antes de su preparación. Ideal para los amantes del café.",
    },
    {
      title: "Café molido",
